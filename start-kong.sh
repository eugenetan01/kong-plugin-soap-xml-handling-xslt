...
docker run -d --name kong-database-soap-xml-handling \
  --network=kong-net \
...
-e "KONG_PROXY_LISTEN=0.0.0.0:1000, 0.0.0.0:1443 ssl http2" \
-e "KONG_ADMIN_LISTEN=0.0.0.0:1001, 0.0.0.0:1444 ssl http2" \
-e "KONG_ADMIN_GUI_LISTEN=0.0.0.0:1002, 0.0.0.0:1445 ssl" \
-e "KONG_ADMIN_GUI_URL=http://localhost:1002" \
